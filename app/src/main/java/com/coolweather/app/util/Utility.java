...
public class Utility {
    ...
    /**
     * deal with the province data from the weather service workstation
     *
     * @param coolWeatherDB
     * @param response
     * @return
    ...
    /**
     * deal with the city data from the weather service workstation
     *
     * @param coolWeatherDB
     * @param response
     * @return
    ...
    /**
     * deal with the county data from the weather service workstation
     *
     * @param coolWeatherDB
     * @param response
     * @return
